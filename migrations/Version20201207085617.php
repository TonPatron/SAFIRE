 ...
 */
final class Version20201207085617 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE anime ADD CONSTRAINT FK_13045942BCF5E72D FOREIGN KEY (categorie_id) REFERENCES categorie (id)');
